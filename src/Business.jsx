        ...
        <section className="introduction-section">
          ...
          <div className="card">
            ...
            <div className="button-group">
              <a href="/greatfortheplanet/?tab=Purchase" className="business-options-button">Get Started</a>
              <a href="/greatfortheplanet/?tab=AboutUs" className="individuals-options-button">Learn More</a>
            </div>
          </div>
          <div className="card">
            <h2 className="title-in-second-card">
