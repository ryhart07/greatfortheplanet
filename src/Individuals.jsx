        ...
        <section className="introduction-section">
          ...
          <div className="card">
            ...
            <div className="button-group">
              <a href="/greatfortheplanet/purchase" className="events-button">Calculate Your Offset</a>
              <a href="/greatfortheplanet/projects" className="projects-button">View Projects</a>
            </div>
